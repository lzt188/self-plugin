/**
 * dsh-usage — provider balance schemes.
 *
 ...
 * response into a normalized view:
 *   { isAvailable, currency, total, used, limit, granted, toppedUp }
 *
 * Providers without a public balance API map to no scheme — the UI shows an
 * explicit "no public balance interface" state instead of guessing.
 *
 * API facts and normalization semantics follow the upstream provider docs;
 * the scheme organization is informed by dsh-usage-stats (MIT,
 * https://github.com/Ychris12138/dsh-usage-stats), reimplemented here so this
